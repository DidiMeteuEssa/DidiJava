...
public void mostra_noh (int posicao)
    {
        ...
        {
            System.out.println();
            System.out.println("| Posicao | Id       | Nome                           | Sexo | Anterior | Nome do Anterior               | Próximo  | Nome do Próximo                |");
            System.out.println("| ------- | -------- | ------------------------------ | ---- | -------- | ------------------------------ | -------- | ------------------------------ |");
        }
        if (this.getProximo() == null)
        {
            ...
            {
                System.out.format ("| %7d | %8d | %-30s |   %1d  |     null | - - - - - - - - - - - - - - -  |     null | - - - - - - - - - - - - - - -  |",
                    posicao, this.getId(), this.getNome(), this.getSexo());
                System.out.println();
            }
            else
            {
                System.out.format ("| %7d | %8d | %-30s |   %1d  | %8d | %-30s |     null | - - - - - - - - - - - - - - -  |",
                    posicao, this.getId(), this.getNome(), this.getSexo(), 
                             this.getAnterior().id, this.getAnterior().nome);
                System.out.println();
            }
        }
        else
        {
            if (this.getAnterior() == null)
            {
                System.out.format ("| %7d | %8d | %-30s |   %1d  |     null | - - - - - - - - - - - - - - -  | %8d | %-30s |",
                    posicao, this.getId(), this.getNome(), this.getSexo(),
            ...
            {
                System.out.format ("| %7d | %8d | %-30s |   %1d  | %8d | %-30s | %8d | %-30s |",
                    posicao, this.getId(), this.getNome(), this.getSexo(),
                    this.getAnterior().getId(), this.getAnterior().getNome(),
                    this.getProximo().getId(), this.getProximo().getNome());
                System.out.println();               
